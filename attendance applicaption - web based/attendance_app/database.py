...
CREATE VIEW IF NOT EXISTS faculty_details AS
SELECT *
FROM users
WHERE role = 'faculty';
"""
...
def create_role_views(db):
    # Rebuild the role-specific views so student and faculty records stay separated logically.
    db.executescript(
        """
